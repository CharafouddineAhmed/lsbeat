...
`${GOPATH}/src/github.com/CharafouddineAhmed/lsbeat`
...
```
git remote set-url origin https://github.com/CharafouddineAhmed/lsbeat
...
```
mkdir -p ${GOPATH}/src/github.com/CharafouddineAhmed/lsbeat
git clone https://github.com/CharafouddineAhmed/lsbeat ${GOPATH}/src/github.com/CharafouddineAhmed/lsbeat
```
